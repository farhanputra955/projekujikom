...
<head>
    ...
    <link rel="stylesheet" href="{{ asset ('assets/baru/css/preload.css')}}">
...
<font color=white>Loading...</font>
    ...
    <div class="service_area oyeah">
        ...
        <a href="/beritalainnya">
            <center><p1>Lihat Semua Berita...</p1></center>
            <br>
            <br>
            <br>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_service wow fadeInLeft" data-wow-duration="1.2s" data-wow-delay=".5s">
                        ...
                        <div class="service_content">
                            <ul>
                                <li>  {{Str::limit($data->konten, 250)}} </li>
