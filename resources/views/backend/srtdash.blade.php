...
<head>
    ...
    <link rel="icon" href="{{ asset ('assets/img/dash.png')}}">
    <title>Srtdash ICO Dashboard</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" type="image/png" href="{{ asset ('assets/srtdash/images/icon/favicon.ico')}}">
...
<body>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-pie-chart"></i><span>Pesantren</span></a>
                                <ul class="collapse">
                                    <li><a href="{{ url('admin/pesantren') }}">Pondok</a></li>
                                    <li><a href="{{ url('admin/provinsi') }}">Provinsi</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-palette"></i><span>Doa Harian</span></a>
                                <ul class="collapse">
                                    <li><a href="{{ url('admin/more') }}">Doa Sehari Hari</a></li>
                                    <li><a href="{{ url('admin/doaseharihari') }}">Kategori Doa</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-slice"></i><span>Kisah - Kisah</span></a>
                                <ul class="collapse">
                                    <li><a href="{{ url('admin/nabi') }}">Kisah</a></li>
                                    <li><a href="{{ url('admin/kisah') }}">Kategori Kisah</a></li>
                                </ul>
                            </li>
    ...
    <script src="{{ asset ('assets/srtdash/js/line-chart.js')}}"></script>
    <!-- all pie chart -->
    <script src="{{ asset ('assets/srtdash/js/pie-chart.js')}}"></script>
    <!-- others plugins -->
