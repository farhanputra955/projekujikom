...
<body>
    ...
    <header class="header-area">
        ...
        <div class="logo-area text-center">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <a href="index.html" class="original-logo"><img src="{{ asset ('assets/blog/img/core-img/logo.png')}}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="breadcumb-area bg-img" style="background-image: url(/assets/blog/img/bg-img/b1.jpg);">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
    ...
    <div class="cool-facts-area section-padding-100-0 bg-img background-overlay" style="background-image: url(/assets/blog//img/bg-img/b4.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-12">
