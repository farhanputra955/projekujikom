    ...
    <header class="header-area">
        ...
        <div class="logo-area text-center">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <a href="index.html" class="original-logo"><img src="{{ asset ('assets/blog/img/core-img/blog.png')}}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="single-blog-wrapper section-padding-0-100">
        ...
        <div class="single-blog-area blog-style-2 mb-50">
            <div class="single-blog-thumbnail">
                <img src="{{ asset ('assets/blog/img/bg-img/b5.jpg')}}" alt="">
                ...
                <div class="col-12 col-lg-9">
                    ...
                    <div class="blog-post-author mt-100 d-flex">
                        <div class="author-thumbnail">
                            <img src="{{ asset ('assets/blog/img/bg-img/b6.jpg')}}" alt="">
                        </div>
                            ...
                            <li class="single_comment_area">
                                ...
                                <div class="comment-content d-flex">
                                    ...
                                    <div class="comment-author">
                                        <img src="{{ asset ('assets/blog/img/bg-img/b7.jpg')}}" alt="author">
                                    </div>
                                    <!-- Comment Meta -->
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="post-sidebar-area">
                        ...
                        <div class="sidebar-widget-area">
                            ...
                            <a href="#"><img src="{{ asset ('assets/blog/img/bg-img/add.gif')}}" alt=""></a>
                        </div>
