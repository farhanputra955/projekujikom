...
<head>
	...
	<link rel="stylesheet" href="{{ asset ('assets/megna/plugins/themefisher-font/style.css')}}">
	<!-- bootstrap.min css -->
	<link rel="stylesheet" href="{{ asset ('assets/megna/plugins/bootstrap/dist/css/bootstrap.min.css')}}">
	<!-- Animate.css -->
	<link rel="stylesheet" href="{{ asset ('assets/megna/plugins/animate-css/animate.css')}}">
	<!-- Magnific popup css -->
	<link rel="stylesheet" href="{{ asset ('assets/megna/plugins/magnific-popup/dist/magnific-popup.css')}}">
	<!-- Slick Carousel -->
	<link rel="stylesheet" href="{{ asset ('assets/megna/plugins/slick-carousel/slick/slick.css')}}">
	<link rel="stylesheet" href="{{ asset ('assets/megna/plugins/slick-carousel/slick/slick-theme.css')}}">
	<!-- Main Stylesheet -->
	<link rel="stylesheet" href="{{ asset ('assets/megna/css/style.css')}}">
    ...
    <header id="navigation" class="navbar navigation">
        ...
        <nav class="collapse navbar-collapse navbar-right" role="Navigation">
            <ul id="nav" class="nav navbar-nav navigation-menu">
                ...
                <li><a data-scroll href="#foto">Foto</a></li>
                <li><a data-scroll href="#sosmed">Sosial Media</a></li>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-6 padding-0 ">
				<img class="img-responsive" src="{{ asset ('assets/megna/images/banner/sr4.jpg')}}" alt="">
			</div>
			<div class="col-md-6">
		...
		<div class="row ">
			<div class="col-lg-12">
				...
				<div class="title text-center">
					<h2>Foto <span class="color">Farhan</span></h2>
					<div class="border"></div>
				</div>
				<!-- /section title -->
			</div> <!-- /end col-lg-12 -->
		...
		<div class="row filtr-container">
			<div class="col-lg-4 filtr-item" data-category="development">
				<div class="portfolio-block">
					<img class="img-responsive" src="{{ asset ('assets/megna/images/portfolio/portfolio-1.jpg')}}" alt="">
					<div class="caption">
			...
			<div class="filtr-item col-md-4" data-category="design">
				<div class="portfolio-block">
					<img class="img-responsive" src="{{ asset ('assets/megna/images/portfolio/portfolio-8.jpg')}}" alt="">
					<div class="caption">
...
<section id="sosmed" class="section">
	<div class="container">
		<div class="row">
		
			<!-- section title -->
			<div class="title text-center wow fadeInUp" data-wow-duration="500ms">
				<h2>Sosial <span class="color">Media</span></h2>
				<div class="border"></div>
			</div>
			<!-- /section title -->
			...
			<div class="col-md-3 col-sm-6 col-xs-12  wow fadeInDown" data-wow-duration="500ms">
               <div class="team-member">
					<div class="member-photo">
						<!-- member photo -->
						<img class="img-responsive" src="{{ asset ('assets/megna/images/team/aa.jpg')}}" alt="Meghna">
						<!-- /member photo -->
...
<footer id="footer" class="bg-one">
	<div class="container">
		...
		<!-- Main jQuery -->
		<script type="text/javascript" src="{{ asset ('assets/megna/plugins/jquery/dist/jquery.min.js')}}"></script>
		<!-- Bootstrap 3.1 -->
		<script type="text/javascript" src="{{ asset ('assets/megna/plugins/bootstrap/dist/js/bootstrap.min.js')}}"></script>
		<!-- Slick Carousel -->
		<script type="text/javascript" src="{{ asset ('assets/megna/plugins/slick-carousel/slick/slick.min.js')}}"></script>
		<!-- Portfolio Filtering -->
		<script type="text/javascript" src="{{ asset ('assets/megna/plugins/filterzr/jquery.filterizr.min.js')}}"></script>
		<!-- Smooth Scroll -->
		<script type="text/javascript" src="{{ asset ('assets/megna/plugins/smooth-scroll/dist/js/smooth-scroll.min.js')}}"></script>
		<!-- Magnific popup -->
		<script type="text/javascript" src="{{ asset ('assets/megna/plugins/magnific-popup/dist/jquery.magnific-popup.min.js')}}"></script>
		<!-- Google Map API -->
		<script type="text/javascript"  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBu5nZKbeK-WHQ70oqOWo-_4VmwOwKP9YQ"></script>
		<!-- Sticky Nav -->
		<script type="text/javascript" src="{{ asset ('assets/megna/plugins/Sticky/jquery.sticky.js')}}"></script>
		<!-- Number Counter Script -->
		<script type="text/javascript" src="{{ asset ('assets/megna/plugins/count-to/jquery.countTo.js')}}"></script>
		<!-- wow.min Script -->
		<script type="text/javascript" src="{{ asset ('assets/megna/plugins/wow/dist/wow.min.js')}}"></script>
		<!-- Custom js -->
